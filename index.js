...
function cls(t){const l=t.toLowerCase();if(/sim|quero|pode|claro|ok|top|bom|interesse/.test(l))return'sim';if(/nao|nao|depois|ocupado|negativo/.test(l))return'nao';if(/quanto|valor|taxa|juros/.test(l))return'valor';return'padrao'}
const M={sim:()=>'Que tipo de operacao voce precisa? Credito ou investimento? Me conta mais!',nao:n=>'Sem problema '+n+'! Estou a disposicao. Abracoes!',valor:n=>'Trabalhamos com credito a partir de R$100k. Qual o valor, '+n+'?',padrao:n=>'Recebi sua mensagem, '+n+'! Um especialista entrara em contato em breve.'};
